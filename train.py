...
""" 'bfloat16' if torch.cuda.is_available() and torch.cuda.is_bf16_supported() else  """
dtype = 'float16' # 'float32', 'bfloat16', or 'float16', the latter will auto implement a GradScaler
compile = False # use PyTorch 2.0 to compile the model to be faster
# get train/val bins off HuggingFace
hf_binaries=False

# Define additional configurations for FrostQuantix if needed
text_embed_size = 768
...
if init_from == 'scratch':
    ...
    model = FrostQuantix.from_pretrained(init_from, override_args)
...
if device_type == 'cuda':
    ...
    scaler = None
# scaler = torch.cuda.amp.GradS caler(enabled=(dtype == 'float16'))
